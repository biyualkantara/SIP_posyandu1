...
onMounted(() => {
  console.log('=== DATA DARI CONTROLLER (WAFAT) ===');
  console.log('Full row:', props.row);
  console.log('Nama Kecamatan:', props.row?.nama_kec);
  console.log('Nama Kelurahan:', props.row?.nama_kel);
  console.log('Nama Posyandu:', props.row?.nama_posyandu);
  console.log('Nama Bayi:', props.row?.nama_bayi);
  console.log('Nama Ibu:', props.row?.nama_wuspus);
  console.log('NIK Ibu:', props.row?.nik_wuspus);
  console.log('=====================================');
})
...
function submitForm() {
  if (!form.tgl_kematian) {
    openError('Tanggal kematian wajib diisi')
    return
  }

  showToast('info', 'Menyimpan data...', 0)

  form.put(`/posyandu/bayi-wafat/${props.row.id_wafat}`, {
    preserveScroll: true,
    onSuccess: () => {
      hideToast()
      openSuccess('Data kematian bayi berhasil diperbarui')
      setTimeout(() => {
        window.location.href = '/posyandu/bayi-wafat'
      }, 1000)
    },
    onError: (errors) => {
      hideToast()
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Data Kematian Bayi</h1>
          <p class="page-subtitle">Edit data kematian bayi</p>
        </div>
        <div class="header-right">
          <Link href="/posyandu/bayi-wafat" class="btn-back">
            <span>←</span>
            <span>Kembali</span>
          </Link>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="filter-section">
              <h6 class="filter-section-title">Informasi Bayi & Ibu</h6>
              ...
              <div class="filter-grid-2 mt-3">
                <div class="filter-item">
                  <label class="filter-label">Nama Bayi</label>
            ...
            <div class="form-actions">
              <Link href="/posyandu/bayi-wafat" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
