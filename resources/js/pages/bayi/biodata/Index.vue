  ...
  <Transition name="slide-fade">
    ...
    <div class="data-container">
        ...
        <div class="header-section">
            <div>
                <h1 class="page-title">Data Bayi</h1>
                <p class="page-subtitle">Kelola biodata bayi posyandu</p>
            </div>
        ...
        <div class="table-section">
            ...
            <DataTable v-else :columns="columns" :rows="rows" :perPage="20">
                ...
                <template #col-id_bayi="{ row }">
                    <span class="id-badge">#{{ row.id_bayi }}</span>
                </template>
        ...
        <div class="pagination-section"
             v-if="props.data?.links?.length && rows.length > 0">

            <div class="pagination-info">
                Menampilkan {{ props.data.from }} - {{ props.data.to }}
    ...
    <div v-if="modalOpen" class="modal-overlay" @click.self="closeModal">
        <div class="modal-content">
          ...
          <h3 class="modal-title">Hapus Data Biodata?</h3>
