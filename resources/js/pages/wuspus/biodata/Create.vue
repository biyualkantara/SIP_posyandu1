...
function validateRow(row, index) {
  ...
  if (!row.nik_wuspus) errors.push('NIK WUS/PUS harus diisi')
  if (!row.nama_wuspus) errors.push('Nama WUS/PUS harus diisi')
...
function submit() {
  ...
  form.post('/posyandu/wuspus/store-multiple', {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess(`${form.rows.length} data biodata WUS/PUS berhasil disimpan`)
      setTimeout(() => {
        router.visit('/posyandu/wuspus')
      }, 1500)
    },
    onError: (errors) => {
      hideToast()
  ...
  <div class="data-container">
    ...
    <div class="header-section">
      <div class="header-left">
        <h1 class="page-title">Tambah Biodata WUS/PUS</h1>
        <p class="page-subtitle">Input multi data peserta WUS/PUS</p>
      </div>
      <div class="header-right">
        <Link href="/posyandu/wuspus" class="btn-back">
          <span>←</span>
          <span>Kembali</span>
        </Link>
      </div>
        ...
        <form @submit.prevent="submit">
          ...
          <div v-if="form.posyandu_id" class="data-rows-section">
            <div class="section-header">
              <h6 class="section-title">Data WUS/PUS</h6>
              ...
              <div class="form-grid-2">
                <div class="form-field">
                  ...
                  <input 
                    ...
                    :class="{ 'input-error': !row.nik_wuspus && showModal }"
                  >
                </div>
                <div class="form-field">
                  ...
                  <input 
                    ...
                    :class="{ 'input-error': !row.nama_wuspus && showModal }"
                  >
                </div>
              </div>
