...
function submit() {
  ...
  form.post('/posyandu/bumil-pnb/store-multiple', {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess(`${form.rows.length} data penimbangan bumil berhasil disimpan`)
      setTimeout(() => {
        router.visit('/posyandu/bumil-pnb')
      }, 1500)
    },
    onError: (errors) => {
      hideToast()
  ...
  <div class="data-container">
    ...
    <div class="header-section">
      <div class="header-left">
        <h1 class="page-title">Tambah Penimbangan Ibu Hamil (BUMIL)</h1>
        <p class="page-subtitle">Input multi data penimbangan ibu hamil</p>
      </div>
        ...
        <form @submit.prevent="submit">
          ...
          <div v-if="form.posyandu_id" class="data-rows-section">
            <div class="section-header">
              <h6 class="section-title">Data Penimbangan BUMIL</h6>
            ...
            <div v-for="(row, i) in form.rows" :key="i" class="data-card">
              ...
              <div class="form-grid-3 mt-3">
                <div class="form-field">
                  <label>Tanggal PNB <span class="text-danger">*</span></label>
                  <input 
                    type="date" 
                    class="form-input" 
                    v-model="row.tgl_pnb"
