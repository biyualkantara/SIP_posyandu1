...
function submitForm() {
  if (!form.nama_bayi) {
    openError('Nama bayi wajib diisi')
    return
  }
  if (!form.jk) {
    openError('Jenis kelamin wajib dipilih')
    return
  }
  if (!form.tgl_lhr) {
    openError('Tanggal lahir wajib diisi')
    return
  }
  ...
  form.put(`/posyandu/bayi/${props.row.id_bayi}`, {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess('Data bayi berhasil diperbarui')
      setTimeout(() => {
        window.location.href = '/posyandu/bayi'
      }, 1000)
    },
    onError: (errors) => {
      hideToast()
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Data Bayi</h1>
          <p class="page-subtitle">Edit data bayi</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="filter-section">
              ...
              <div class="filter-grid-2 mt-3">
                ...
                <div class="filter-item">
                  ...
                  <div class="readonly-field">{{ displayData.nama_bayi }}</div>
                </div>
              </div>
            </div>
            ...
            <div class="data-card">
              ...
              <div class="form-grid-2 mt-3">
                <div class="form-field">
                  ...
                  <select class="form-input" v-model="form.jk">
            ...
            <div class="form-actions">
              <Link href="/posyandu/bayi" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
