...
function submitForm() {
  ...
  form.put(`/posyandu/wuspus-kematian/${props.row.id}`, {
    preserveScroll: true,
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Kematian WUS/PUS</h1>
          <p class="page-subtitle">Edit data kematian WUS/PUS</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="filter-section">
              <h6 class="filter-section-title">Informasi Lokasi</h6>
            ...
            <div class="filter-section mt-4">
              <h6 class="filter-section-title">Informasi WUS/PUS</h6>
              <div class="filter-grid-3">
                <div class="filter-item">
                  <label class="filter-label">NIK</label>
