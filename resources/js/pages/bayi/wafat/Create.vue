...
function validateRow(row, index) {
  ...
  if (!row.tgl_kematian) errors.push('Tanggal kematian harus diisi')
...
function submit() {
  ...
  form.post('/posyandu/bayi-wafat/store-multiple', {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess(`${form.rows.length} data kematian bayi berhasil disimpan`)
      
      // Kirim event ke index untuk toast
      window.dispatchEvent(new CustomEvent('toast', {
        detail: { type: 'success', message: 'Data kematian bayi berhasil disimpan!' }
      }));

      setTimeout(() => {
        router.visit('/posyandu/bayi-wafat')
      }, 1500)
    },
    onError: (errors) => {
      hideToast()
  ...
  <div class="data-container">
    ...
    <div class="header-section">
      <div class="header-left">
        <h1 class="page-title">Tambah Data Kematian Bayi</h1>
        <p class="page-subtitle">Input multi data kematian bayi</p>
      </div>
        ...
        <form @submit.prevent="submit">
          ...
          <div v-if="form.posyandu_id" class="data-rows-section">
            <div class="section-header">
              <h6 class="section-title">Data Kematian Bayi</h6>
