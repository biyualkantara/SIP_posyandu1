...
<div class="p-4 bg-white main-container">
  <div class="header-flex mb-3">
    ...
    <Link href="/posyandu/wuspus-kematian/create" class="btn btn-primary">+ Tambah Data</Link>
  </div>
  ...
  <DataTable :columns="columns" :rows="rows" :perPage="10">
    <template #col-actions="{ row }">
      ...
      <span class="bg-danger p-3 rounded-circle text-white" style="cursor:pointer"
            @click="askDelete(row)">
