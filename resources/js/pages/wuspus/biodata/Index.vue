  ...
  <AdminLayout>
    ...
    <div v-if="modalOpen" class="overlay-blur" @click.self="closeModal">
      <div class="modal-card">
        <h3 class="modal-title">Hapus Data Biodata WUS/PUS?</h3>
        <hr>
        ...
        <div class="data-preview mt-2">
            ...
            <!-- <div class="mt-2">
                <span class="label">Posyandu</span>
                <div class="value">
                    {{ selected.nama_posyandu }}
                </div>
            </div> -->
            ...
            <div>
                <span 
                    class="status-badge"
                    :class="{
                        'status-red': selected.status === 'Meninggal',
                        'status-green': selected.status === 'Aktif',
                        'status-gray': selected.status !== 'Meninggal' && selected.status !== 'Aktif'
                    }"
                >
                    {{ selected.status }}
                </span>
