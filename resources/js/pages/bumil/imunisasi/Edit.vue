...
function submitForm() {
  ...
  form.put(`/posyandu/bumil-imun/${props.row.id_bumil_imun}`, {
    preserveScroll: true,
    onSuccess: () => {
      hideToast()
      openSuccess('Data imunisasi bumil berhasil diperbarui')
      setTimeout(() => {
        window.location.href = '/posyandu/bumil-imun'
      }, 1000)
    },
    onError: (errors) => {
      hideToast()
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Imunisasi Bumil</h1>
          <p class="page-subtitle">Edit data imunisasi ibu hamil</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="data-card">
              ...
              <div class="form-grid-2">
                <div class="form-field">
                  ...
                  <select class="form-input" v-model.number="form.id_imun">
            ...
            <div class="form-actions">
              <Link href="/posyandu/bumil-imun" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
