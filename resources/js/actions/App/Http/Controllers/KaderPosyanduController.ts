...
/**
* @see \App\Http\Controllers\KaderPosyanduController::exportExcel
 * @see [unknown]:0
 * @route '/api/kader-export/excel'
 */
...
/**
* @see \App\Http\Controllers\KaderPosyanduController::exportPdf
 * @see [unknown]:0
 * @route '/api/kader-export/pdf'
 */
...
/**
* @see \App\Http\Controllers\KaderPosyanduController::printSingle
 * @see [unknown]:0
 * @route '/api/kader-posyandu/{id}/print'
 */
...
printSingle.definition = {
    methods: ["get","head"],
    url: '/api/kader-posyandu/{id}/print',
} satisfies RouteDefinition<["get","head"]>
...
const KaderPosyanduController = { index, store, show, update, destroy, exportExcel, exportPdf, printSingle }

export default KaderPosyanduController