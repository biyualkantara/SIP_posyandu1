...
function validateRow(row, index) {
  ...
  if (row.medis === "" || row.medis === null) errors.push('Medis harus diisi')
...
function submit() {
  ...
  form.post('/posyandu/kehadiran-kader/store-multiple', {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess(`${form.rows.length} data kehadiran kader berhasil disimpan`)
      setTimeout(() => {
  ...
  <div class="data-container">
    ...
    <div class="header-section">
      <div class="header-left">
        ...
        <p class="page-subtitle">Input multi data kehadiran kader posyandu</p>
      </div>
              ...
              <div class="form-grid-2">
                ...
                <div class="form-field">
                  ...
                  <input 
                    ...
                    class="form-input" 
                    v-model="row.bulan"
                    :class="{ 'input-error': !row.bulan && showModal }"
