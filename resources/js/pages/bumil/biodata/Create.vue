...
function submit() {
  ...
  form.post('/posyandu/bumil/store-multiple', {
    ...
    onSuccess: () => {
      hideToast()
      openSuccess(`${form.rows.length} data ibu hamil berhasil disimpan`)
      setTimeout(() => {
  ...
  <div class="data-container">
    ...
    <div class="header-section">
      <div class="header-left">
        <h1 class="page-title">Tambah Data Ibu Hamil (BUMIL)</h1>
        <p class="page-subtitle">Input multi data ibu hamil</p>
      </div>
        ...
        <form @submit.prevent="submit">
          ...
          <div v-if="form.posyandu_id" class="data-rows-section">
            <div class="section-header">
              <h6 class="section-title">Data Ibu Hamil</h6>
