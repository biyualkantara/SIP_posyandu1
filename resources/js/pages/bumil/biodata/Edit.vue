...
function submitForm() {
  ...
  form.put(`/posyandu/bumil/${props.row.id_bumil}`, {
    preserveScroll: true,
    onSuccess: () => {
      hideToast()
      openSuccess('Data BUMIL berhasil diperbarui')
      setTimeout(() => {
        window.location.href = '/posyandu/bumil'
      }, 1000)
    },
    onError: (errors) => {
      hideToast()
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Data BUMIL</h1>
          <p class="page-subtitle">Edit data ibu hamil</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="form-actions">
              <Link href="/posyandu/bumil" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
