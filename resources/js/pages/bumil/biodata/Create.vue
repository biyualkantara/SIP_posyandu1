...
<div class="bg-white p-4 main-container">
  <div class="header-flex mb-3">
    <h2>Tambah Data Ibu Hamil (BUMIL)</h2>
  ...
  <form @submit.prevent="submit">
    ...
    <Table class="mt-4">
      <TableHead>
        <TableRow>
          <TableCol asHead>Form BUMIL</TableCol>
          ...
          <TableCol>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 mb-3">
                ...
                <input type="number" class="form-control" v-model="row.umur_kehamilan">
              </div>

              <div class="col-lg-4 mb-3">
                <label>Hamil Ke</label>
                <input type="number" class="form-control" v-model="row.hamil_ke">
              </div>

              <div class="col-lg-4 mb-3">
                <label>LILA</label>
                <input type="number" step="0.01" class="form-control" v-model="row.lila">
              </div>

              <div class="col-lg-6 mb-3">
                <label>PMT Pemulihan</label>
                <input class="form-control" v-model="row.pmt_pemulihan" maxlength="100">
              </div>
