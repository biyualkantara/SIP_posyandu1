...
function submitForm() {
  ...
  if (!form.berat) {
    openError('Berat badan wajib diisi')
    return
  }
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Penimbangan Bayi</h1>
          <p class="page-subtitle">Edit data penimbangan bayi</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="form-actions">
              <Link href="/posyandu/bayi-pnb" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
