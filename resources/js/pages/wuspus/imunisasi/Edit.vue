...
function submitForm() {
  ...
  form.put(`/posyandu/wuspus-imun/${props.row.id_wuspus_imun}`, {
    ...
    onSuccess: () => {
      ...
      setTimeout(() => {
        window.location.href = '/posyandu/wuspus-imun'
      }, 1000)
    },
    onError: (errors) => {
      hideToast()
    ...
    <div class="data-container">
      ...
      <div class="header-section">
        <div class="header-left">
          <h1 class="page-title">Edit Imunisasi WUS/PUS</h1>
          <p class="page-subtitle">Edit data imunisasi WUS/PUS</p>
        </div>
        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="form-actions">
              <Link href="/posyandu/wuspus-imun" class="btn-cancel">
                <span>✕</span>
                <span>Batal</span>
              </Link>
